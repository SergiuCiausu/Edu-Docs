              ...
              <div
                ...
                <div
                  className="py-16 flex-1">
                    <h1>Matematică, Mate-info, clasa a IX-a, Utilizarea conceptelor, metodelor și procedeelor matematice, Mulțimi și operații cu mulțimi</h1>
                    <p>
                    ...
                    <div
                        ...
                        {capitole.map((capitol, index) => (
                            <button key={index} className="px-16 py-8 flex items-center justify-center rounded-2xl capitol-btn cursor-pointer" onClick={() => router.push(`/materii/matematica/mate-info/clasa-a-ix-a/utilizarea-conceptelor-metodelor-si-procedeelor-matematice/multimi-si-operatii-cu-multimi/${capitol.link}`)}>{capitol.nume}</button> 
                        ))}
                    </div>
                </div>
              </div>
