              ...
              <div
                ...
                <div
                  className="py-16 flex-1">
                    <h1>Matematică, Științe sociale, clasa a IX-a, Utilizarea conceptelor, metodelor și procedeelor matematice, Numere reale</h1>
                    <p>
                    ...
                    <div
                        ...
                        {capitole.map((capitol, index) => (
                            <button key={index} className="px-16 py-8 flex items-center justify-center rounded-2xl capitol-btn cursor-pointer" onClick={() => router.push(`/materii/matematica/stiinte-sociale/clasa-a-ix-a/utilizarea-conceptelor-metodelor-si-procedeelor-matematice/numere-reale/${capitol.link}`)}>{capitol.nume}</button> 
                        ))}
                    </div>
                </div>
              </div>
