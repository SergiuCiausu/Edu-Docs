              ...
              <div
                ...
                <div
                  className="py-16 flex-1">
                    <h1>Științe socio-umane, Mate-info</h1>
                    <p>
                    ...
                    <div
                        ...
                        {capitole.map((capitol, index) => (
                            <button key={index} className="px-16 py-8 flex items-center justify-center rounded-2xl capitol-btn cursor-pointer" onClick={() => router.push(`/materii/stiinte-socio-umane/mate-info/${capitol.link}`)}>{capitol.nume}</button> 
                        ))}
                    </div>
                </div>
              </div>
