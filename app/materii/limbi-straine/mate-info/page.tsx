...
import { titluri } from "@/app/data/capitole-limbi-straine-mate-info";
                  ...
                  className="py-16 flex-1">
                    ...
                    <div
                        ...
                        {capitole.map((capitol, index) => (
                            <button key={index} className="px-16 py-8 flex items-center justify-center rounded-2xl capitol-btn cursor-pointer" onClick={() => router.push(`/materii/limbi-straine/mate-info/${capitol.link}`)}>{capitol.nume}</button> 
                        ))}
                    </div>
                </div>
              </div>
