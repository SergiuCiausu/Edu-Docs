                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h1>Biologie, Științe ale naturii, clasa a XII-a</h1>
                            ...
                            <div
                                ...
                                {capitole.map((capitol, index) => (
                                   <button key={index} className="px-16 py-8 flex items-center justify-center rounded-2xl capitol-btn cursor-pointer" onClick={() => router.push(`/materii/biologie/stiinte-ale-naturii/clasa-a-xii-a/${capitol.link}`)}>{capitol.nume}</button> 
                                ))}
                            </div>
                        </div>
                    </div>
