                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h1>Fizică, Științe sociale, clasa a X-a, Termodinamică</h1>
                            <p>                    
                            ...
                            <div
                                ...
                                {capitole.map((capitol, index) => (
                                   <button key={index} className="px-16 py-8 flex items-center justify-center rounded-2xl capitol-btn cursor-pointer" onClick={() => router.push(`/materii/fizica/stiinte-sociale/clasa-a-x-a/termodinamica/${capitol.link}`)}>{capitol.nume}</button> 
                                ))}
                            </div>
                        </div>
                    </div>
