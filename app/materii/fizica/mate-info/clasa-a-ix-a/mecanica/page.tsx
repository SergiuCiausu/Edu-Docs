                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h1>Fizică, Mate-info, clasa a IX-a, Mecanică</h1>
                            <p>                    
                            ...
                            <div
                                ...
                                {capitole.map((capitol, index) => (
                                   <button key={index} className="px-16 py-8 flex items-center justify-center rounded-2xl capitol-btn cursor-pointer" onClick={() => router.push(`/materii/fizica/mate-info/clasa-a-ix-a/mecanica/${capitol.link}`)}>{capitol.nume}</button> 
                                ))}
                            </div>
                        </div>
                    </div>
