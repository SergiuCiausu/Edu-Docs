                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h1>Fizică, Știinte ale naturii, clasa a XII-a, Fizică atomică</h1>
                            <p>                    
                            ...
                            <div
                                ...
                                {capitole.map((capitol, index) => (
                                   <button key={index} className="px-16 py-8 flex items-center justify-center rounded-2xl capitol-btn cursor-pointer" onClick={() => router.push(`/materii/fizica/stiinte-ale-naturii/clasa-a-xii-a/fizica-atomica/${capitol.link}`)}>{capitol.nume}</button> 
                                ))}
                            </div>
                        </div>
                    </div>
