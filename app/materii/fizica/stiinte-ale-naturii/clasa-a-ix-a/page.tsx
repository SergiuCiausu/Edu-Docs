...
import { titluriCapitole } from "@/app/data/capitole-fizica-mate-info-capitole-9";
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h1>Fizică, Științe ale naturii, clasa a IX-a</h1>
                            <p>                    
                            ...
                            <div
                                ...
                                {capitole.map((capitol, index) => (
                                   <button key={index} className="px-16 py-8 flex items-center justify-center rounded-2xl capitol-btn cursor-pointer" onClick={() => router.push(`/materii/fizica/stiinte-ale-naturii/clasa-a-ix-a/${capitol.link}`)}>{capitol.nume}</button> 
                                ))}
                            </div>
                        </div>
                    </div>
